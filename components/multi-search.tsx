          ...
          >
            <div className="flex items-center justify-between w-full">
              ...
              <div className="flex items-center gap-2 mr-2">
                <Badge variant="secondary" className="rounded-full px-3 py-1 bg-neutral-100 dark:bg-neutral-800">
  ...
  return (
    <div className="w-[300px] flex-shrink-0 bg-background rounded-xl border border-border shadow-sm hover:shadow-md transition-all">
      <div className="p-4">
        ...
        <p className="text-sm text-muted-foreground line-clamp-3 mb-3">{result.content}</p>
    ...
    <div>
      ...
      {isDesktop ? (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          <DialogContent className="max-w-5xl h-[80vh] p-0" showClose={false}>
