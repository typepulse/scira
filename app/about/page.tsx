      ...
      <div className="relative">
        ...
        <div className="relative pt-20 pb-20 px-4">
          ...
          >
            ...
            <motion.form variants={item} className="max-w-2xl mx-auto w-full" onSubmit={handleSearch}>
            ...
            <motion.div variants={item} className="text-center space-y-6">
              <p className="text-xl text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
                A minimalistic AI-powered search engine with RAG and search grounding capabilities. Open source and
                built for everyone.
              </p>
            </motion.div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="prose prose-sm dark:prose-invert">
                  <p className="text-neutral-900 dark:text-neutral-100">
                    Quantum computing is a revolutionary technology that harnesses quantum mechanics to solve complex
                    problems...
                  </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 rounded-2xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 flex flex-col items-center justify-center gap-4">
              <VercelLogo />
              <p className="text-neutral-600 dark:text-neutral-400 text-center">Powered by Vercel&apos;s AI SDK</p>
            </div>
            <div className="p-8 rounded-2xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 flex flex-col items-center justify-center gap-4">
              <TavilyLogo />
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative aspect-video rounded-xl overflow-hidden bg-neutral-100 dark:bg-neutral-800">
              <img src="/vercel-featured.png" alt="Featured on Vercel Blog" className="object-cover w-full h-full" />
            </div>
          </div>
        </motion.div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6 rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800">
              ...
              <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-2">
                Best-in-class performance with real-time knowledge
              </p>
            </div>
            <div className="p-6 rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800">
              <h3 className="font-semibold">Claude 3.5</h3>
              <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-2">
                Exceptional understanding of queries and sources
              </p>
            </div>
            <div className="p-6 rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800">
